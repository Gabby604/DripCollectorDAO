 ...
 * ```
 */
export declare function isClaimERC721Supported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeClaimERC721(options: ClaimERC721Params): `0x1290be10${string}`;
/**
