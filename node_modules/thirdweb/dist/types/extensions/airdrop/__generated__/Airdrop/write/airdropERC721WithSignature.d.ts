 ...
 * ```
 */
export declare function isAirdropERC721WithSignatureSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeAirdropERC721WithSignature(options: AirdropERC721WithSignatureParams): `0xb654a6f3${string}`;
/**
