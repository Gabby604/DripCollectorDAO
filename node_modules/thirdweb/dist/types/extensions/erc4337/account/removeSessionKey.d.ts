 ...
 * @extension ERC4337
 */
export declare function removeSessionKey(options: BaseTransactionOptions<RemoveSessionKeyOptions>): import("../../../transaction/prepare-transaction.js").PreparedTransaction<any, import("abitype").AbiFunction>;
