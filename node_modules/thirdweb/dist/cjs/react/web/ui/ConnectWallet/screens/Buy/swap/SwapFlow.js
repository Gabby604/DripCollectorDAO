...
function SwapFlow(props) {
    ...
    const fromChain = (0, react_1.useMemo)(() => (0, utils_js_1.defineChain)(quote.swapDetails.fromToken.chainId), [quote]);
    const toChain = (0, react_1.useMemo)(() => (0, utils_js_1.defineChain)(quote.swapDetails.toToken.chainId), [quote]);
    ...
    if (swapTxHash) {
        return ((0, jsx_runtime_1.jsx)(SwapStatusScreen_js_1.SwapStatusScreen, { onBack: props.onBack, onTryAgain: props.onTryAgain, onViewPendingTx: props.onViewPendingTx, swapTxHash: swapTxHash, client: props.client, onDone: props.onDone, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed, quote: quote }));
    }
