 ...
 * ```
 */
export declare function isTryBlockAndAggregateSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeTryBlockAndAggregate(options: TryBlockAndAggregateParams): `0x399542e9${string}`;
/**
