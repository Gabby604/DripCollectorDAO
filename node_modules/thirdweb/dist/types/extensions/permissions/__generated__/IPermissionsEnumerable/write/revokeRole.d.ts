 ...
 * ```
 */
export declare function isRevokeRoleSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeRevokeRole(options: RevokeRoleParams): `0xd547741f${string}`;
/**
