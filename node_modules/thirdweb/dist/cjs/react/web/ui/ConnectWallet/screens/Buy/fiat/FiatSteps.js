...
exports.FiatSteps = exports.fiatQuoteToPartialQuote = void 0;
...
function FiatSteps(props) {
    ...
    const toChain = (0, react_1.useMemo)(() => (0, utils_js_1.defineChain)(toTokenMeta.chainId), [toTokenMeta.chainId]);
    const destinationChain = (0, react_1.useMemo)(() => {
        if (props.status?.status !== "NOT_FOUND" && props.status?.destination) {
            return (0, utils_js_1.defineChain)(props.status?.destination.token.chainId);
        }
        return undefined;
    }, [props.status]);
    ...
    const onRampChain = (0, react_1.useMemo)(() => (0, utils_js_1.defineChain)(onRampTokenMeta.chainId), [onRampTokenMeta.chainId]);
    ...
    const onRampTokenIcon = ((0, jsx_runtime_1.jsx)(TokenIcon_js_1.TokenIcon, { token: onRampToken, chain: onRampChain, size: "sm", client: props.client }));
    const toTokenIcon = ((0, jsx_runtime_1.jsx)(TokenIcon_js_1.TokenIcon, { token: toToken, chain: toChain, size: "sm", client: props.client }));
