 ...
 * ```
 */
export declare function isAggregate3Supported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeAggregate3(options: Aggregate3Params): `0x82ad56cb${string}`;
/**
