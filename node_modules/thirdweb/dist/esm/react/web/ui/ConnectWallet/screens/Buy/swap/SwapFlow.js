...
export function SwapFlow(props) {
    ...
    const fromChain = useMemo(() => defineChain(quote.swapDetails.fromToken.chainId), [quote]);
    const toChain = useMemo(() => defineChain(quote.swapDetails.toToken.chainId), [quote]);
    ...
    if (swapTxHash) {
        return (_jsx(SwapStatusScreen, { onBack: props.onBack, onTryAgain: props.onTryAgain, onViewPendingTx: props.onViewPendingTx, swapTxHash: swapTxHash, client: props.client, onDone: props.onDone, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed, quote: quote }));
    }
    return (_jsx(SwapConfirmationScreen, { setSwapTxHash: setSwapTxHash, toChain: toChain, toAmount: toAmount, toTokenSymbol: toTokenSymbol, fromChain: fromChain, toToken: toToken, fromAmount: fromAmount, fromToken: fromToken, fromTokenSymbol: fromTokenSymbol, client: props.client, onBack: props.onBack, onTryAgain: props.onTryAgain, quote: quote, isFiatFlow: props.isFiatFlow }));
}
