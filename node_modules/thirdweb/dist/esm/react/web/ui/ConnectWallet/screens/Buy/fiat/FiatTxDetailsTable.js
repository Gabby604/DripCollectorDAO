...
export function OnRampTxDetailsTable(props) {
    ...
    return (_jsxs("div", { children: [_jsx(TokenInfoRow, { chainId: props.token.chainId, client: props.client, label: "Receive", tokenAmount: props.token.amount, tokenSymbol: props.token.symbol, tokenAddress: props.token.address }), lineSpacer, _jsxs(Container, { flex: "row", style: {
                    justifyContent: "space-between",
                }, children: [_jsx(Text, { children: "Pay" }), _jsx(Container, { flex: "column", gap: "xxs", style: {
                            alignItems: "flex-end",
                        }, children: _jsxs(Container, { flex: "row", gap: "xs", center: "y", children: [props.fiat.currencySymbol === "USD" && (_jsx(USDIcon, { size: iconSize.sm })), _jsxs(Text, { color: "primaryText", children: [formatNumber(Number(props.fiat.amount), 4), " ", props.fiat.currencySymbol] })] }) })] }), props.statusMeta && (_jsxs(_Fragment, { children: [lineSpacer, _jsxs(Container, { flex: "row", center: "y", style: {
                            justifyContent: "space-between",
