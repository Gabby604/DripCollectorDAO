...
exports.BuyTxHistoryButton = exports.BuyTxHistoryButtonHeight = void 0;
...
function BuyTxHistoryButton(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(TxButton, { onClick: props.onClick, variant: "secondary", fullWidth: true, style: {
            paddingBlock: index_js_1.spacing.sm,
                    ...
                    flex: 1,
                }, children: [(0, jsx_runtime_1.jsx)(TokenIcon_js_1.TokenIcon, { client: props.client, chain: (0, utils_js_1.defineChain)(props.txInfo.status.quote.toToken.chainId), size: "md", token: {
                            ...
                            justifyContent: "center",
                                    ...
                                    justifyContent: "space-between",
                                                ...
                                                : props.txInfo.status.quote.estimatedToTokenAmount), 4), " ", props.txInfo.status.quote.toToken.symbol] }), " "] }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xxs" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", center: "y", gap: "xxs", style: {
                                    justifyContent: "space-between",
                                }, children: (0, jsx_runtime_1.jsx)(ChainName_js_1.ChainName, { chain: (0, utils_js_1.defineChain)(props.txInfo.status.quote.toToken.chainId), size: "xs", client: props.client }) })] })] }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", gap: "xxs", center: "y", children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", color: statusMeta.color, children: statusMeta.status }) })] }));
}
