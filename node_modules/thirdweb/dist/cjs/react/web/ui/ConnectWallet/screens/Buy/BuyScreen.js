                ...
                if (drawerScreen &&
                    ...
                    closeDrawer();
                        ...
                        paddingBottom: 0,
                            ...
                            }, account: account })), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" })] })), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "lg", flex: "column", gap: "sm", children: [account && ((0, jsx_runtime_1.jsx)(buttons_js_1.Button, { variant: "outline", fullWidth: true, style: {
                                padding: index_js_1.spacing.xs,
                                fontSize: index_js_1.fontSize.sm,
                            }, onClick: props.onViewPendingTx, children: "View all transactions" })), !isExpanded && ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: !account && props.connectButton ? ((0, jsx_runtime_1.jsx)("div", { children: props.connectButton })) : ((0, jsx_runtime_1.jsx)(buttons_js_1.Button, { variant: "accent", fullWidth: true, disabled: true, "data-disable": true, children: "Continue" })) }))] }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" })] }) }));
}
