...
export function FiatSteps(props) {
    ...
    const toChain = useMemo(() => defineChain(toTokenMeta.chainId), [toTokenMeta.chainId]);
    ...
    const onRampChain = useMemo(() => defineChain(onRampTokenMeta.chainId), [onRampTokenMeta.chainId]);
    ...
    const onRampTokenIcon = (_jsx(TokenIcon, { token: onRampToken, chain: onRampChain, size: "sm", client: props.client }));
    const toTokenIcon = (_jsx(TokenIcon, { token: toToken, chain: toChain, size: "sm", client: props.client }));
