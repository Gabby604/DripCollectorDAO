 ...
 * ```
 */
export declare function executeSale(options: BaseTransactionOptions<ExecuteSaleParams>): import("../../../../transaction/prepare-transaction.js").PreparedTransaction<any, import("abitype").AbiFunction>;
