 ...
 * ```
 */
export declare function buyoutAuction(options: BaseTransactionOptions<BuyoutAuctionParams>): import("../../../../transaction/prepare-transaction.js").PreparedTransaction<any, import("abitype").AbiFunction>;
