 ...
 * ```
 */
export declare function prepareDeterministicDeployTransaction(options: DeployDetemisiticParams): import("../../transaction/prepare-transaction.js").PreparedTransaction<[], import("abitype").AbiFunction>;
