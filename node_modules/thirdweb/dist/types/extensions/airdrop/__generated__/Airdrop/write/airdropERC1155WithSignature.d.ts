 ...
 * ```
 */
export declare function isAirdropERC1155WithSignatureSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeAirdropERC1155WithSignature(options: AirdropERC1155WithSignatureParams): `0xd0d4afd6${string}`;
/**
