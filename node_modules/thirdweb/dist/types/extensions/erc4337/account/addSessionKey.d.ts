 ...
 * @extension ERC4337
 */
export declare function addSessionKey(options: BaseTransactionOptions<AddSessionKeyOptions>): import("../../../transaction/prepare-transaction.js").PreparedTransaction<any, import("abitype").AbiFunction>;
