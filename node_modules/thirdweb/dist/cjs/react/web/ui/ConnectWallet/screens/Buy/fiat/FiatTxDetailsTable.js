...
exports.OnRampTxDetailsTable = void 0;
...
function OnRampTxDetailsTable(props) {
    const onRampChainQuery = (0, useChainQuery_js_1.useChainQuery)((0, utils_js_1.defineChain)(props.token.chainId));
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(TokenInfoRow_js_1.TokenInfoRow, { chainId: props.token.chainId, client: props.client, label: "Receive", tokenAmount: props.token.amount, tokenSymbol: props.token.symbol, tokenAddress: props.token.address }), lineSpacer, (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", style: {
                    justifyContent: "space-between",
                            ...
                            alignItems: "flex-end",
                        }, children: (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "xs", center: "y", children: [props.fiat.currencySymbol === "USD" && ((0, jsx_runtime_1.jsx)(USDIcon_js_1.USDIcon, { size: index_js_1.iconSize.sm })), (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", children: [(0, formatNumber_js_1.formatNumber)(Number(props.fiat.amount), 4), " ", props.fiat.currencySymbol] })] }) })] }), props.statusMeta && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [lineSpacer, (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", center: "y", style: {
                            justifyContent: "space-between",
