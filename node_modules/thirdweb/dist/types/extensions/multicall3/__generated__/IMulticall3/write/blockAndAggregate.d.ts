 ...
 * ```
 */
export declare function isBlockAndAggregateSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeBlockAndAggregate(options: BlockAndAggregateParams): `0xc3077fa9${string}`;
/**
