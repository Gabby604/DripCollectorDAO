...
function PayEmbed(props) {
    ...
    if (!localeQuery.data) {
        ...
        content = ((0, jsx_runtime_1.jsx)(BuyTxHistory_js_1.BuyTxHistory, { client: props.client, onBack: () => {
                setScreen("buy");
            }, onDone: () => {
                // noop
        ...
        content = ((0, jsx_runtime_1.jsx)(BuyScreen_js_1.default, { isEmbed: true, supportedTokens: props.supportedTokens, theme: props.theme || "dark", client: props.client, connectLocale: localeQuery.data, onViewPendingTx: () => {
