 ...
 * ```
 */
export declare function setContractMetadata({ contract, ...restParams }: BaseTransactionOptions<SetContractMetadataParams>): import("../../../transaction/prepare-transaction.js").PreparedTransaction<any, import("abitype").AbiFunction>;
