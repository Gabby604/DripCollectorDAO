...
export function BuyTxHistoryButton(props) {
    ...
    return (_jsxs(TxButton, { onClick: props.onClick, variant: "secondary", fullWidth: true, style: {
            paddingBlock: spacing.sm,
                    ...
                    flex: 1,
                }, children: [_jsx(TokenIcon, { client: props.client, chain: defineChain(props.txInfo.status.quote.toToken.chainId), size: "md", token: {
                            ...
                            justifyContent: "center",
                                    ...
                                    justifyContent: "space-between",
                                                ...
                                                : props.txInfo.status.quote.estimatedToTokenAmount), 4), " ", props.txInfo.status.quote.toToken.symbol] }), " "] }), _jsx(Spacer, { y: "xxs" }), _jsx(Container, { flex: "row", center: "y", gap: "xxs", style: {
                                    justifyContent: "space-between",
                                }, children: _jsx(ChainName, { chain: defineChain(props.txInfo.status.quote.toToken.chainId), size: "xs", client: props.client }) })] })] }), _jsx(Container, { flex: "row", gap: "xxs", center: "y", children: _jsx(Text, { size: "xs", color: statusMeta.color, children: statusMeta.status }) })] }));
}
