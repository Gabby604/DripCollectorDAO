 ...
 * ```
 */
export declare function isRenounceRoleSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeRenounceRole(options: RenounceRoleParams): `0x36568abe${string}`;
/**
